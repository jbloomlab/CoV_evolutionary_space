---
title: "analyze space of tolerated muts"
author: "tns"
date: "3/3/2022"
output:
  github_document:
...
Synthesize different functional and evolutionary metrics to approximate the space of realized and possible coronavirus evolution
...
Read in data: SARS-CoV-2 DMS data, GISAID mutation counts, and sarbecovirus diversity
...
First, annotate mutations that have been observed during SARS-CoV-2 genomic surveillance with some appreciable frequency.

```{r choose_gisaid_threshold, echo=T, fig.width=4, fig.height=4, fig.align="center", dpi=300,dev="png"}
...
Next, add an indicator of whether a mutation is tolerated with respect to mutational impact on ACE2 binding affinity. Define a threshold relative to the range of ACE2 binding values that have been seen among mutations with appreciable frequency on GISAID.

```{r choose_dms_threshold, echo=T, fig.width=8, fig.height=6, fig.align="center", dpi=300,dev="png"}
...
Next, add an indicator of whether a mutation is observed in an alignment of SARS-related coronaviruses, excluding the "Clade 2" sequences that do not apparently utilize ACE2 as a receptor even in their native bat hosts.

```{r sarbecovirus_variation, echo=T, fig.width=8, fig.height=6, fig.align="center", dpi=300,dev="png"}
...
```{r omicron_muts, echo=T, fig.width=8, fig.height=6, fig.align="center", dpi=300,dev="png"}
#annotate whether a mutation has been observed in other sarbecoviruses
...
```{r save_file, echo=T, fig.width=8, fig.height=6, fig.align="center", dpi=300,dev="png"}
